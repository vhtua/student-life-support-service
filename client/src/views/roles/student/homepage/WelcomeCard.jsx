...
import SkeletonEarningCard from 'views/roles/student/ui-component/cards/Skeleton/EarningCard';
            ...
            <Grid container direction="column">
              ...
              <Grid item>
                <Grid container alignItems="center">
                  <Grid item>
                    <Typography sx={{ fontSize: '2.125rem', fontWeight: 500, mr: 1, mt: 1.75, mb: 0.75 }}>Welcome {localStorage.getItem("fullName")}</Typography>
                  </Grid>
                  <Grid item>
                    <Avatar
                      sx={{
